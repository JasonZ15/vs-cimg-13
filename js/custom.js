(function($){
	...
	$(document).ready(function(){
		...
		$('.post-content div.one_fourth').filter(function(index){
 return (index%4 == 3);
}).addClass('last').after("<div class='clear'></div><p>&nbsp;</p>");
		$('.page-template-page-landing-chn-php #email-list').after("<a href='http://www.gmic-sv.com/wp-content/uploads/2012/07/GMIC-SV-Brochure-chinese.pdf' class='action-button' target='_blank' id='gmic-sv-brochure' style='margin-top:2px;margin-left:5px;'><span class='color'><span class='text'>下载大会中文简介</span></span></a>");
